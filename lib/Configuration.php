...
namespace Stackflows\GatewayApi;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://virtserver.swaggerhub.com/Stackflows/Gateway/1.0.0';
    ...
    {
        $report  = 'PHP SDK (Stackflows\GatewayApi) Debug Report:' . PHP_EOL;
