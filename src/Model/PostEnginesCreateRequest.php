...
/**
 * PostEnginesCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Stackflows\Clients\Stackflows
 * @author   OpenAPI Generator team
 ...
 */
class PostEnginesCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnginesCreate_request';
     ...
     * Sets path
     *
     * @param string $path Must not be greater than 255 characters.
     *
     * @return self
     */
     ...
     * Sets auth
     *
     * @param string $auth Must not be greater than 255 characters.
     *
     * @return self
     */
