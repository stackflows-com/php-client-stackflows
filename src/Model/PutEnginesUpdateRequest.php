...
/**
 * PutEnginesUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Stackflows\Clients\Stackflows
 * @author   OpenAPI Generator team
 ...
 */
class PutEnginesUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putEnginesUpdate_request';
     ...
     * Sets path
     *
     * @param string|null $path Must not be greater than 255 characters.
     *
     * @return self
     */
     ...
     * Sets auth
     *
     * @param string|null $auth Must not be greater than 255 characters.
     *
     * @return self
     */
